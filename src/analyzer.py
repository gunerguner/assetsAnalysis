...
class AssetAnalyzer:
    ...
    def analyze_basic(self, data: list[AssetData]) -> str:
        ...
        up_assets = [d for d in data if d.change_percent and d.change_percent > 0]
        down_assets = [d for d in data if d.change_percent and d.change_percent < 0]
        flat_assets = [d for d in data if d.change_percent and d.change_percent == 0]
